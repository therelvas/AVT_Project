...
Frog.prototype.setupObjects = function() {
	...
	this.cube.setColor("ambient", [ 0.05, 0.05, 0.0, 1.0]);
	this.cube.setColor("diffuse", [0.1, 0.55, 0.1, 1.0]);
	this.cube.setColor("specular", [0.35, 0.65, 0.45, 1.0]);
	this.cube.setColor("emissive", [0.727811, 0.626959, 0.626959, 1.0]);
	this.cube.setColor("shininess", 0.25);
...
Frog.prototype.render = function(shaderProgram) {
...
Frog.prototype.renderReflection = function(shaderProgram) {
	...
	pushMatrix();
	mat4.translate(mMatrix, [this.x, -(this.y +1), this.z]);
...
Frog.prototype.move = function(x, y, z, speed){
	...
	if (!(this.x + x*speed <= 32 && this.iX + x*speed >= 0))
		return;
